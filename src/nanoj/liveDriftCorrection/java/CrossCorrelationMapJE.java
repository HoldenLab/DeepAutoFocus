...
public class CrossCorrelationMap {
     ...
     * @param ip2
     */
    private static FloatProcessor _calculateCrossCorrelationMap(FloatProcessor ip1, FloatProcessor ip2, boolean normalized, boolean PreFHT1, boolean PreFHT2) {
        FloatProcessor h1 = ip1;
        FloatProcessor h2 = ip2;
        if (!PreFHT1) h1 = NJ_FHT.forwardFHT(ip1);
        if (!PreFHT2) h2 = NJ_FHT.forwardFHT(ip2);
