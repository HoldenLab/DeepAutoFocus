...
The version in the v1.0.0 release is associated with the Whitley et al Nat Comms 2021 paper and was originally developed between the Henriques and Holden laboratories. This plugin will perform lateral drift correction and/or axial autofocus at depth using the infrared camera allowing separate imaging with visible fluorescence light.
